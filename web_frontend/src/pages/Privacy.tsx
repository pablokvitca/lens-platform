    ...
    <div className="py-12 max-w-3xl mx-auto">
      ...
      <div className="prose prose-slate max-w-none">
        <p className="text-lg text-slate-600 mb-8">
          Lens Academy ("we", "us", "our") is committed to protecting your privacy. This policy explains how we collect, use, and protect your personal data when you use our AI safety education platform.
        </p>
        ...
        <section className="mb-8">
          ...
          <h3 className="text-lg font-medium text-slate-800 mt-4 mb-2">2.1 Account Information</h3>
          <p className="text-slate-600 mb-2">When you sign up via Discord, we receive:</p>
          ...
          <h3 className="text-lg font-medium text-slate-800 mt-4 mb-2">2.2 Profile Information</h3>
          ...
          <h3 className="text-lg font-medium text-slate-800 mt-4 mb-2">2.3 Learning Progress</h3>
          <p className="text-slate-600 mb-2">To provide the educational service:</p>
          <ul className="list-disc pl-6 text-slate-600 space-y-1">
          ...
          <h3 className="text-lg font-medium text-slate-800 mt-4 mb-2">2.4 Analytics Data (With Consent)</h3>
          <p className="text-slate-600 mb-2">If you consent to analytics cookies, we collect:</p>
          <ul className="list-disc pl-6 text-slate-600 space-y-1">
          ...
          <h3 className="text-lg font-medium text-slate-800 mt-4 mb-2">2.5 Error Tracking (With Consent)</h3>
          <p className="text-slate-600">
          ...
          <h3 className="text-lg font-medium text-slate-800 mt-4 mb-2">2.6 Geolocation</h3>
          <p className="text-slate-600">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-slate-600 space-y-2">
            <li><strong>Provide the service:</strong> Authenticate you, track course progress, schedule group sessions, send reminders</li>
            <li><strong>Communication:</strong> Send course updates, meeting reminders, and important notifications via email or Discord DM</li>
            <li><strong>Improve the platform:</strong> Analyze usage patterns (with consent) to improve the learning experience</li>
            <li><strong>Technical operation:</strong> Debug issues, ensure security, prevent abuse</li>
          </ul>
        </section>

        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 mb-4">4. Legal Basis for Processing (GDPR)</h2>
          <ul className="list-disc pl-6 text-slate-600 space-y-2">
            <li><strong>Contract:</strong> Processing account and learning data to provide the educational service you signed up for</li>
            <li><strong>Consent:</strong> Analytics and error tracking cookies (you can withdraw anytime)</li>
            ...
            <table className="min-w-full text-sm text-slate-600">
              <thead>
                <tr className="border-b border-slate-200">
                  <th className="text-left py-2 pr-4 font-medium text-slate-800">Service</th>
                  <th className="text-left py-2 pr-4 font-medium text-slate-800">Purpose</th>
                  <th className="text-left py-2 font-medium text-slate-800">Data Location</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
                <tr>
                  ...
                  <td className="py-2">US (Discord's privacy policy applies)</td>
                </tr>
                <tr>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-slate-600 space-y-2">
            ...
            <li><strong>Learning progress:</strong> Retained for course completion records. May be anonymized for research after account deletion.</li>
            <li><strong>Analytics data:</strong> Retained for up to 2 years, then deleted or anonymized.</li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-slate-600 space-y-2">
            ...
            <li><strong>Withdraw consent:</strong> Withdraw analytics/tracking consent at any time</li>
          </ul>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-slate-600 space-y-2">
            <li><strong>Essential:</strong> Authentication tokens, consent preferences (always active)</li>
            <li><strong>Analytics:</strong> PostHog tracking (requires consent)</li>
            <li><strong>Error tracking:</strong> Sentry session data (requires consent)</li>
          </ul>
          <p className="text-slate-600 mt-4">
        ...
        <section className="mb-8 p-4 bg-violet-50 rounded-lg">
          <h2 className="text-lg font-semibold text-violet-900 mb-2">Supervisory Authority</h2>
